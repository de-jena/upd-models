...
The Maven group-id is defaulted to **de.jena.udp-models** in *cnf/build.bnd* using the bnd **-groupid** instruction.

## Github - Create Project
- Create a empty [GitHub repository](https://github.com/organizations/geckoprojects-org/repositories/new)
  - Name: `de.jena.udp-models`
...
## Sonarcloud
  ...
  - Analyze new project
  - check `de.jena.udp-models` and `SetUp`
  ...
  - GitHub -> Project-Settings -> Secrets -> [New Repository Secrets](Link: https://github.com/geckoprojects-org/de.jena.udp-models/settings/secrets/actions/new)
    - add `SONAR_TOKEN`
...
git branch -M main
git remote add origin git@github.com:geckoprojects-org/de.jena.udp-models.git
...
- Project -> Settings  -> Branches [add rule](https://github.com/geckoprojects-org/de.jena.udp-models/settings/branch_protection_rules/new)
...
- [Jenkins GitHub-Group](https://devel.data-in-motion.biz/jenkins/job/GH/) should show `de.jena.udp-models`
- [Jenkins de.jena.udp-models branches](https://devel.data-in-motion.biz/jenkins/job/GH/job/de.jena.udp-models/)
