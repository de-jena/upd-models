...
The Maven group-id is defaulted to **de.jena.upd-models** in *cnf/build.bnd* using the bnd **-groupid** instruction.

## Github - Create Project
- Create a empty [GitHub repository](https://github.com/organizations/geckoprojects-org/repositories/new)
  - Name: `de.jena.upd-models`
...
## Sonarcloud
  ...
  - Analyze new project
  - check `de.jena.upd-models` and `SetUp`
  ...
  - GitHub -> Project-Settings -> Secrets -> [New Repository Secrets](Link: https://github.com/geckoprojects-org/de.jena.upd-models/settings/secrets/actions/new)
    - add `SONAR_TOKEN`
...
git branch -M main
git remote add origin git@github.com:geckoprojects-org/de.jena.upd-models.git
...
- Project -> Settings  -> Branches [add rule](https://github.com/geckoprojects-org/de.jena.upd-models/settings/branch_protection_rules/new)
...
- [Jenkins GitHub-Group](https://devel.data-in-motion.biz/jenkins/job/GH/) should show `de.jena.upd-models`
- [Jenkins de.jena.upd-models branches](https://devel.data-in-motion.biz/jenkins/job/GH/job/de.jena.upd-models/)
